...
static final com.github.romualdrousseau.shuju.nlp.StringList flowerNames = new com.github.romualdrousseau.shuju.nlp.StringList(new String[] { "I. setosa", "I. versicolor", "I. virginica" });
...
public DataSet loadTrainingSet(String fileName) {
    ...
    StringColumn flowerNameCol = new StringColumn(flowerNames);
