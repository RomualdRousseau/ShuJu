...
static final int MAX_SCORE_TRAINING = 1000;
...
static final float PILLAR_SIZE = 64;
static final float PILLAR_SCROLLING_SPEED = -20;
static final float PILLAR_INTERVAL = 300.0; // Main factor of difficulty; the smaller, the closer are the pillars! 
