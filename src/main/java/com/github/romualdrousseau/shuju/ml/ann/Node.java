...
abstract class Node {
    ...
    public void getWeights(double rate, HashMap<Node, Double> cachedOutputs, HashMap<Node, Double> cachedErrors,
    ...
    protected void updateWeights(double rate, HashMap<Node, Double> cachedOutputs, HashMap<Node, Double> cachedErrors,
            HashMap<Edge, Double> weights) {
        assert (this.incomingEdges != null);
        Double error = cachedErrors.get(this);
        assert (error != null);
