...
public class QLearner {
    ...
    public boolean explore(double confidence) {
        ...
        // Choose and take the action from the state using policy predicted from Q (e.g.
        // e-greedy)
        ...
        // Update the Q-value for the state using the observed reward and the maximum
        // reward possible for the next state
