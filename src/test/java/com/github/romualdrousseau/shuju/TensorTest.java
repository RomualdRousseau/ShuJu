...
public class TensorTest {
    ...
    public void testArange() {
        Tensor M1 = Tensor.arange(1, 5, 1);
        Tensor M2 = Tensor.of(1.0f, 2.0f, 3.0f, 4.0f);
        assertThat(M1, equalTo(M2, 0.0f));
    ...
    public void testSum() {
        ...
        Tensor M2 = Tensor.of(10, 12, 14, 16, 18, 20, 22, 24).reshape(2, 4);
        Tensor M3 = Tensor.of(6, 8, 10, 12, 22, 24, 26, 28).reshape(2, 4);
        Tensor M4 = Tensor.of(10, 26, 42, 58).reshape(2, 2);
    ...
    public void testMin() {
        Tensor M1 = Tensor.arange(1, 17, 1).reshape(4, 4);
        Tensor M2 = Tensor.of(1, 2, 3, 4);
        Tensor M3 = Tensor.of(1, 5, 9, 13);
    ...
    public void testMax() {
        Tensor M1 = Tensor.arange(1, 17, 1).reshape(4, 4);
        Tensor M2 = Tensor.of(13, 14, 15, 16);
        Tensor M3 = Tensor.of(4, 8, 12, 16);
    ...
    public void testArgMin() {
        Tensor M1 = Tensor.arange(1, 17, 1).reshape(4, 4);
        Tensor M2 = Tensor.of(0, 1, 2, 3);
        Tensor M3 = Tensor.of(0, 4, 8, 12);
    ...
    public void testArgMax() {
        Tensor M1 = Tensor.arange(1, 17, 1).reshape(4, 4);
        Tensor M2 = Tensor.of(12, 13, 14, 15);
        Tensor M3 = Tensor.of(3, 7, 11, 15);
    ...
    public void testCov() {
        Tensor M1 = Tensor.arange(1, 5, 1);
        Tensor M2 = Tensor.arange(2, 10, 2);
        Tensor M3 = Tensor.of(-2.1f, -1, 4.3f, 3, 1.1f,  0.12f).reshape(2, 3);
        Tensor M4 = Tensor.of(13.005f, 5.355f, -10.659f, 5.355f, 2.205f, -4.389f, -10.659f, -4.389f, 8.736f).reshape(3, 3);
        Tensor M5 = Tensor.of(11.71f, -4.286f, -4.286f, 2.144f).reshape(2, 2);
    ...
    public void testMatMul() {
        ...
        Tensor M2 = Tensor.of(1, 1, 1, 0, 1, 0, 1, 1, 1).reshape(3, 3);
        Tensor M3 = Tensor.of(4, 6, 4, 10, 15, 10, 4, 6, 4, 10, 15, 10).reshape(2, 2, 3);
